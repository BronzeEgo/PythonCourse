...
s = range(7) #gives you integers 0 through 6 (the count starts at 0 and is excluded)
e = range(1,8) #gives you integers 1 through 7 (the last number is never included)
