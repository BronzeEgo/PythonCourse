...
def hi():
    return 'hi'
    print('This will not show') #This does not show any output because return exited the function before it could be run.
def square_of_7():
    7**2
    'alkjha'
...
def square_of_7_(): #I cannot have 2 functions with same name
    return 7**2
    'alkjha' #VSCode is nice enough to let me know this is 'unreachable' because it does nothing...
    #the above code will not return a value out, so, if I did this:
...
def exponents_default_square(num, power=2): #th2 '=something' after the parameter gives it a default value
    return num ** power
...
full_name(last='Steele', first='Colt')#note how I was able to provide the arguments out of order by providing the parameter as a keyword
