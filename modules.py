...
print(random.choice(['apple', 'banana', 'cherry', 'durian'])) #randomly picks one
print(random.shuffle(['apple', 'banana', 'cherry', 'durian'])) #randomly shuffles list

#if I wanted to refer to the module as another name

import random as rand #I can now call on the random module using 'rand' instead of 'random'

print(rand.choice(['apple', 'banana', 'cherry', 'durian'])) #randomly picks one
print(rand.shuffle(['apple', 'banana', 'cherry', 'durian'])) #randomly shuffles list
