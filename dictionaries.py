...
{}.fromkeys(['emails'], 'unknown') #This is merging a list and a string to make {'emails': 'unknown'}. If there were multiple items in the key list, it would assign each the vlaue 'unknown'
{}.fromkeys(['emails', 'phone'], 'unknown') #This is showing what I was talking about at the end of the previous comment. {'emails': 'unknown', 'phone': 'unknown'}
{}.fromkeys('a',[1,2,3,4,5]) #This add a single key to the list making {'a': [1,2,3,4,5]}
...
squared_numbers = {key: value ** 2 for key,value in numbers.items()} #note that ** squares the value
...
answer = {count: chr(count) for count in range(65,91)} #run this to see what you get
