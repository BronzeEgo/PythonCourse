...
second_tuple = tuple(5,6,7) #why would I ever do this (except to make it clear to someone what is going on that does not understand what is going on....)
...
cat.items() #dict_items([('name', 'Tink'), ('Age', 'Old')]) #Those are tuples in there...
